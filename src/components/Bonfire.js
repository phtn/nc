...
export default props => (
  <div style={styles.container}>
    <div style={styles.innerContainer}>
        ...
        <Slider {...settings}>
          ...
          <div style={{margin: '0 auto'}}>
            <Image.Group>
              <Image size='large' src={Bonfire} spaced/>
            </Image.Group>
          </div>
          ...
          <div style={{margin: '0 auto'}}>
            <Image.Group>
              <Image size='large' src={Shrimp} spaced/>
            </Image.Group>
          </div>
          <div style={{margin: '0 auto'}}>
            <Image.Group>
              <Image size='large' src={Beans} />
            </Image.Group>
          </div>

          <div>
            <Image.Group>
              <Image size='large' src={Burger} />
            </Image.Group>
          </div>
          <div>
            <Image.Group>
              <Image size='large' src={Chimi} />
            </Image.Group>
          </div>

          <div>
            <Image.Group>
              <Image size='large' src={Humus2} />
            </Image.Group>
          </div>
          <div>
            <Image.Group>
              <Image size='large' src={Humus1} />
            </Image.Group>
          </div>
    ...
    <div style={styles.address}>
      <Container textAlign='center'>6426 Lower York Rd New Hope, PA 18938 &middot; Clarion Inn & Suites &middot; <br/> Terms of Use | Privacy Policy</Container>
    </div>
